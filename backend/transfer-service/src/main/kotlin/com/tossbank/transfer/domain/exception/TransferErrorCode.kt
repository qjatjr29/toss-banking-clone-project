...
enum class TransferErrorCode(
    ...
    // 이체 관련
    TRANSFER_FAILED(HttpStatus.BAD_REQUEST, "T004", "이체에 실패했습니다"),
    TRANSFER_NOT_FOUND(HttpStatus.NOT_FOUND, "T005", "이체 내역을 찾을 수 없습니다"),
    DUPLICATE_TRANSFER(HttpStatus.CONFLICT, "T006", "이미 처리된 이체 요청입니다"),
    LOCK_ACQUISITION_FAILED(HttpStatus.CONFLICT, "T007", "현재 처리 중인 요청이 있습니다. 잠시 후 다시 시도해주세요"),
    UNAUTHORIZED(HttpStatus.FORBIDDEN, "T008", "이체 접근 권한이 없습니다"),
    TRANSFER_IN_PROGRESS(HttpStatus.ACCEPTED, "T009", "이체 처리 중입니다"),
